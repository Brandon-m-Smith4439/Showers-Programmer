...
Current release: **Version 0.61 — FP-S Short Cut Hinges-Up Detection**
...
The project uses a pre-1.0 release series. The current release is **Version 0.61**. Each revision advances by `0.01`:
