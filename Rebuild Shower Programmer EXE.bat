...
set "REQUIRED_FLAGS=%REQUIRED_FLAGS%,settings_window_centered,editable_hinge_orientations,input_only_order_visibility,compact_centered_popups,version_0_84_workflow_settings"
