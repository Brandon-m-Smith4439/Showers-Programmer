...
set "SOURCE_SCAN_INDEX=Backend\shower_scan_index.py"
set "SOURCE_REVIEW_SERVICE=Backend\shower_review_service.py"
set "SOURCE_MAINTENANCE=Backend\shower_maintenance.py"
set "SOURCE_TEMP=Backend\shower_temp.py"
set "SOURCE_STATE=Backend\shower_state.py"
set "SOURCE_TASKS=Backend\shower_tasks.py"
